...
![UK Property Submission Success](docs/evidence/hmrc/SelfAssessment/uk-prop/adjustment.png)

### Other NINO excuted as part of integrated tests

|NINO|API|
|---|---|
|AA325484A|Other Relief|
|AA325484A|Pension Relief|
|AA123457A|State Benefits|

### Test Execution Report


![Test Execution](docs/evidence/hmrc/SelfAssessment/test_execution_report.png)


#### NOTE - Failed tests passed on re-run
...
- Success evidence captured: VAT submission confirmation screenshot with HMRC reference `883109190713`.
...
### What is your organisation’s URL?
...
### Do you advertise your software as 'HMRC recognised'?

- Yes, this designation is displayed on our homepage following successful completion of HMRC's recognition process.

### Do you get your customers' consent before sharing their personal data for marketing?
...
### Does your error handling meet our specification?
...
![UI](docs/evidence/hmrc/ErrorHandling/ui-friendly-error.png)

##### Correlation Id in request

![CorrelationId Header](docs/evidence/hmrc/ErrorHandling/error-correlation-id.png)

##### Server side Correlation Id loging
...
### Do you have a process for notifying HMRC in the case of a security breach?
...
### Do you comply with the UK General Data Protection Regulation (UK GDPR)?
...
## Do you encrypt all customer data that you handle?
...
### Do you ensure that each customer's data cannot be accessed by unauthorised users?
...
###  Do you have access control for employees using customer data?
...
### Can customers get their data from your software if they switch providers?
...
- **Digital Records - Data Export**: We provide mechanisms for customers to export their stored data in commonly accessible formats
...
### Do you store your customers' HMRC sign in details?
...
- **OAuth Tokens Only**: We store only the OAuth access and refresh tokens generated through HMRC's authorization process. These tokens are encrypted at rest and provide time-limited access to HMRC APIs on behalf of the user. The token may be revoked by the ysers at any time.
...
![Pen Test](docs/evidence/hmrc/Intruder_Reports_Summary_From_2026-01-17_To_2026-02-17.png)

### Do you audit security controls to ensure you comply with data protection law?
...
### Have you checked that your software submits fraud prevention data correctly?
...
![Fraud Headers](docs/evidence/hmrc/FraudHeaders.png)


#### Request Header Check

![Request Headers](docs/evidence/hmrc/RequestHeaders.png)
...
### Do you have a privacy policy URL for your software?
...
###  Do you have a terms and conditions URL for your software?
